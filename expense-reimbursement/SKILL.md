...
- **疑似私人/与本行程无关**(水电费、个人订阅、无关国家签证、无票高额单据等)进存疑清单，默认不计入(第五节)；经用户确认属下期/不报的，移入 `下一期/`(见第 8 步后)。
- 其余拿不准的进存疑清单。
...
### 下一期 / 本期不报的材料
经与用户确认属于**下一期报销**或**本期不报**的材料(跨期机票、与本次无关的签证等)，从备份复制一份到 `下一期/` 单独存放，**不计入**本期台账与模板，在审阅报告里列明"已移交下一期"。既不污染本期勾稽，也不丢材料。
